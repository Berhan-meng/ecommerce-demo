    ...
    <Layout>
      <div className={styles.signin_page}>
        <div className={styles.signin_container}>
          ...
          <aside className={styles.signin_promo} aria-hidden>
          ...
          >
            ...
            <form className={styles.signin_form} noValidate>
              <h1 id={styles.signin_title}>Sign in</h1>
              ...
              <label className={styles.field} htmlFor="password">
                <span className={styles.field_label}>Password</span>
              ...
              <div className={`${styles.form_row} ${styles.small}`}>
                ...
                <a className={styles.help_link} href="/help/forgot-password">
              ...
              <div
                className={`${styles.small} ${styles.muted} ${styles.center}`}
              >
                or
              </div>
              ...
              <div
                className={`${styles.signin_footer} ${styles.small} ${styles.muted}`}
              >
